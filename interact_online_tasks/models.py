...
#Fixed randomization: first position empty, so we can use "id_profile"
    ...
    dg_place1=[	' ',	'in Lombardia',	'in Marocco',	'in Cina',	'in Lombardia',	'in Lombardia',	'in Lombardia',	]
    dg_age1=[	' ',	'56',	'23',	'49',	'31',	'61',	'39',	]
    dg_name2=[	' ',	'Patricia',	'Giovanni',	'Anna',	'Alia',	'Patricia',	'Edenjevy',	]
    dg_gen2=[	' ',	'She',	'He',	'She',	'She',	'She',	'He',	]
    dg_place2=[	' ',	'nelle Filippine',	'in Lombardia',	'in Lombardia',	'in Marocco',	'nelle Filippine',	'nelle Filippine',	]
    dg_age2=[	' ',	'47',	'50',	'56',	'50',	'47',	'49',	]
    pd_name1=[	' ',	'Edenjevy',	'Anna',	'Sandra',	'Xing-Fu',	'Oana',	'Elena',	]
    pd_gen1=[	' ',	'He',	'She',	'She',	'He',	'She',	'She',	]
    pd_place1=[	' ',	'nelle Filippine',	'in Lombardia',	'in Perù',	'in Cina',	'in Romania',	'in Lombardia',	]
    ...
    pd_place2=[	' ',	'in Lombardia',	'in Marocco',	'in Perù',	'in Marocco',	'in Lombardia',	'nelle Filippine',	]
    ...
    trust_place1=[	' ',	'nelle Filippine',	'in Cina',	'in Romania',	'in Lombardia',	'nelle Filippine',	'in Lombardia',	]
    ...
    trust_place2=[	' ',	'in Lombardia',	'in Marocco',	'in Marocco',	'in Marocco',	'in Marocco',	'nelle Filippine',	]
    ...
    threat_place=[	' ',	'nelle Filippine',	'in Lombardia',	'in Cina',	'in Lombardia',	'in Lombardia',	'in Lombardia',	]
